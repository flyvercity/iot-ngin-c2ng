...
The autogenerated `c2ng.yml` OpenAPI v.3 defition files contains an exhaustive description of the API (see Part V. API Reference). This information is extracted from Marshmellow definitions in the `module schemas` (see Part IV. Module Reference).
